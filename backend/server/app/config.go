...
func ConfigFromFlags() (*ServerConfig, error) {
	...
	flag.StringVar(&gitHubWebhookSecret, "github_app_webhook_secret",
		"", "The webhook secret configured on the GitHub App, used to verify the signature of incoming webhook requests.")
	...
	config.GitHubAppConfig.WebhookSecret = []byte(gitHubWebhookSecret)
